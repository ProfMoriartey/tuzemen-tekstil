    ...
    <footer className="bg-theme-primary text-theme-bg mt-auto border-t border-theme-primary/40 py-12 md:py-16">
      <div className="container mx-auto max-w-7xl px-4 md:px-8">
        <div className="grid grid-cols-1 gap-10 md:grid-cols-2 lg:grid-cols-4 lg:gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="mt-8 flex items-center gap-5">
              <a
                ...
                className="text-theme-secondary/85 hover:text-theme-accent transition-colors"
              >
          ...
          <div>
            <h4 className="text-theme-bg mb-6 text-sm font-bold tracking-wider uppercase">
              {t("links.title")}
            </h4>
            <ul className="space-y-3">
              {quickLinks.map((link) => (
                <li key={link.path}>
                  <Link
                    href={link.path}
                    className="group flex items-center text-sm transition-colors hover:text-theme-bg"
                  >
                    <ChevronRight className="text-theme-secondary/60 group-hover:text-theme-bg mr-2 h-4 w-4 transition-colors" />
                    {link.name}
                  </Link>
                </li>
              ))}
        ...
        {/* Bottom Bar */}
        <div className="border-theme-primary/40 text-theme-secondary/70 mt-12 flex flex-col items-center justify-between gap-4 border-t pt-8 text-xs md:flex-row">
