      ...
      */}
      ...
      <div className="grid grid-cols-1 gap-10 lg:grid-cols-2 lg:gap-16">
        ...
        <div className="flex flex-col">
          ...
          <button className="bg-theme-accent text-theme-bg cursor-pointer mt-8 flex w-full items-center justify-center rounded-md py-4 font-bold tracking-wide uppercase shadow-sm transition-all hover:opacity-90">
