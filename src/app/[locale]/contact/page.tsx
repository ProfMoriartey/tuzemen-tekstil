    ...
    <div className="bg-theme-bg flex min-h-screen flex-col">
      ...
      <section className="relative flex min-h-87.5 items-center overflow-hidden px-4 py-20 md:py-32">
        ...
        <div className="relative z-10 container mx-auto max-w-4xl text-center">
          <h1 className="text-theme-primary mb-6 text-4xl font-bold tracking-tight uppercase md:text-5xl">
            {t("hero.title")}
          </h1>
          <p className="text-slate-800 mx-auto max-w-2xl text-lg leading-relaxed">
            {t("hero.subtitle")}
          </p>
        </div>
      </section>
      ...
      <section className="px-4 py-16 md:py-24">
        <div className="container mx-auto max-w-7xl">
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-24">
            ...
            <div className="border-theme-primary/20 bg-theme-bg rounded-2xl border p-8 shadow-sm md:p-10">
      ...
      <section className="bg-theme-secondary/20 relative h-100 w-full md:h-125">
        <iframe
